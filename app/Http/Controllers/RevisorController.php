...
class RevisorController extends Controller
{
    ...
    public function acceptArticle(Article $article){
        ...
        $article->save();
        return redirect(route('revisor.dashboard'))->with('message', 'Articolo publicato con successo!');
    }
    ...
    public function undoArticle(Article $article){
        ...
        $article->save();
        return redirect(route('revisor.dashboard'))->with('message', 'Articolo in revisione!');
    }
