<x-layout>
    <div class="container-fluid  text-center">
        <div class="row justify-content-center">
            <div class="col-12">
                <h1 class="display-1 margin-class text-capitalize"> Articoli di {{ $user->name }}</h1>
            </div>
        </div>
    </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="small text-muted">Categoria:
                                <a class="text-capitalize text-muted" href="">{{ $article->category->name }}</a>
                            </p>
                            ...
                            <div class="card-footer d-flex justify-content-between align-items-center bg-body-tertiary">
                                ...
                                <a href="{{ route('article.show', $article) }}" class="btn btn-botton text-white">Leggilo</a>
                            </div>
                        </div>
                    </div>
                </div>
